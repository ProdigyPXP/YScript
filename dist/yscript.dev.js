...
(() => {
  ...
  function iterateText(text, to = "ys") {
    const langCol = to === "ys" ? 1 : 0;
    const Dictionary = sortedYopta_default;
    Dictionary.sort((a, b) => {
  ...
  async function yoptaToJs(scriptNode) {
    if (scriptNode.parentNode !== null) {
      const yoptaText = scriptNode.textContent || await getTxtFromSrc(scriptNode);
      scriptNode.parentNode.removeChild(scriptNode);
      addScriptNode(compile(yoptaText, "ys"));
    }
  }
  async function getTxtFromSrc(node) {
  ...
  function addScriptNode(compiled) {
    const script = document.createElement("script");
    script.innerHTML = compiled;
    document.body.appendChild(script);
  }
})();
//# sourceMappingURL=yscript.dev.js.map
