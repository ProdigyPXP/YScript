/* YScript v2.2.1 (es2021) | Copyright (c) 2016-2026 ProdigyPXP, Yopta.Space project, and Contributors | Licensed under the MIT license */globalThis["yscript"]=Object.create(null);globalThis["yscript"]["distro"]="es2021";globalThis["yscript"]["version"]="2.2.1";
...
`,"Use yscript.compile() instead.","Deprecated as of YScript 0.2.0- support will be removed in YScript 0.3.0"),l(e,t)}globalThis.yscript.compile=l;globalThis.yopta=b;typeof window<"u"&&(document.querySelectorAll('[language="YoptaScript"]').forEach(c),document.querySelectorAll('[language="YScript"]').forEach(c),document.querySelectorAll('[language="Yopta"]').forEach(c),document.querySelectorAll('[type="text/x-yoptascript"]').forEach(c));async function c(e){if(e.parentNode!==null){let t=e.textContent||await C(e);e.parentNode.removeChild(e),S(l(t,"ys"))}}async function C(e){let t=e.getAttribute("src"),o="";return t!==null&&t.length&&(o=await(await fetch(t)).text()),o}function S(e){let t=document.createElement("script");t.innerHTML=e,document.body.appendChild(t)}})();
